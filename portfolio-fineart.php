<?php
/* ───────────────────────────────────────── */
/* Fine-Art Portfolio – PhotoSwipe v5        */
/* ───────────────────────────────────────── */

require_once 'cms/includes/config.php';

$page_title = "Fine-Art Portfolio – Professional Photography & Cinematography";
 $sticky_nav = false;  // uncomment if you prefer a non-sticky nav */
include 'includes/header.php';

/* pull fine-art items + their media */
...
<style>
  ...
  /* dropdown styles identical to other pages */
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      <div class="portfolio-nav">
        ...
        <div class="portfolio-nav-dropdown">
          <a href="portfolio-fineart.php" class="active">FINE ART</a>
...
<script>
/* PhotoSwipe + dropdown toggle */
document.addEventListener('DOMContentLoaded', () => {
  new PhotoSwipeLightbox({
    gallery:'#fineart-gallery',
    children:'a',
