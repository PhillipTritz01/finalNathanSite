<?php
/*  ────────────────────────────────────────────────────────────── */
/*  Fine-Art Portfolio – PhotoSwipe v5 (local assets)             */
/*  ────────────────────────────────────────────────────────────── */
...
/* 1. Fetch fine-art items from the DB */
$conn = getDBConnection();
$stmt = $conn->prepare(
  "SELECT *
     FROM portfolio_items
    WHERE category = 'fineart'
...
<section class="min-h-screen bg-[#ede7df] px-8 py-8 relative">
  <div class="max-w-7xl mx-auto">
    ...
    <!-- Page Title -->
    <h1 class="mb-6 text-2xl md:text-3xl font-bold lowercase text-gray-900"
